            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <img src="{{ $deposit[0]->gateway_currency()->methodImage() }}" class="card-img-top w-25" @lang('gateway-image')">
                    ...
                    <div class="card-body">
                        <form action="{{$data->url}}" method="{{$data->method}}" class="stripe-form">
                            <p class="mt-3 mb-4 text-center">@lang('Please Pay') {{getAmount($deposit[0]->final_amo)}} {{__($deposit[0]->method_currency)}}</p>
                            <script
                                src="{{$data->src}}"
                                class="stripe-button"

    ...
    <div class="cart-section padding-bottom padding-top">
        <div class="container">
                    ...
                    <tr class="cart-row">
                        ...
                        <td data-label="@lang('Action')">
                            <a href="javascript:void(0)">
                                <span class="edit remove-cart" data-id="{{$item->id}}" data-productId="{{$item->product_id}}">
            ...
            <div class="cart-total section-bg ">
                <div class="m--15 d-flex flex-wrap align-items-center justify-content-between">
                    <div class="apply-coupon-code">
                        @auth
                            <input type="text" name="coupon_code" placeholder="Introduzca el código del cupón">
                            <button type="botton" name="coupon_apply">Aplicar Cupón</button>
                        @endauth
                    </div>
                    <div class="total">
            ...
            <div class="checkout mt-3 d-flex justify-content-between">
                <a href="{{route('products')}}" class="theme custom-button">Seguir comprando</a>
                <a href="{{route('user.checkout')}}" class="theme-2 custom-button">@lang('Checkout')</a>
            </div>
            @else

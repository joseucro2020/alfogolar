                            ...
                            <ul class="filter-category">
                                <li>
                                    <a href="javascript:void(0)" data-id="0"
                                        class="@if($category_id == 0)) active @endif"><i class="las la-angle-right"></i>
                                        {{__('All Category')}} </a>
                                </li>
                                ...
                                <li>
                                    <a href="javascript:void(0)" data-id="{{$category->id}}"
                                        class="@if($category_id == $category->id)) active @endif"><i
                ...
                <div class="filter-category-header">
                    ...
                    <div class="fileter-select-item">
                        ...
                        <div class="select-item product-page-per-view">
                            <select class="select-bar bg-3">
                                ...
                                <option value="100" {{@$perpage==100?'selected':''}}>@lang('100 Items Per Page')
                                </option>
                                <option value="200" {{@$perpage==200?'selected':''}}>@lang('200 Items Per Page')
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="fileter-select-item ml-auto ml-lg-0 align-self-end">
                        <ul class="view-style d-flex">
                            <li>
                                <a href="javascript:void(0)" class="active view-grid-style"><i
                ...
                <div class="position-relative">
                    ...
                    <div class="page-main-content">
                        <div class="row mb-30-none page-main-content" id="grid-view">
                            ...
                            $discount = calculateDiscount($item->offer->activeOffer->amount,
                        ...
                        {{$products->appends(['perpage'=>@$perpage, 'category_id'=>$category_id, 'min'=>@$min,
                        'max'=>@$max])->links()}}
                    </div>
                </div>

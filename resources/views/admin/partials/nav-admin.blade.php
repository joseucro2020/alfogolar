    ...
    <div
        ...
        <ul>
            ...
            <li class="sidebar-menu-item {{ menuActive('admin.tags.*') }}">
                <a class="nav-link" href="{{ route('admin.tags.all') }}">
                    <i class="la la-tags menu-icon"></i>
            ...
            <li class="sidebar-menu-item {{ menuActive('admin.products.iva*') }}">
                <a class="nav-link" href="{{ route('admin.products.iva.all') }}">
                    <i class="menu-icon fas fa-receipt"></i>
                    <span class="menu-title">IVA</span>
                </a>
            </li>
        </ul>
    </div>
...
<li class="sidebar-menu-item sidebar-dropdown">
    <a href="javascript:void(0)"
        class="{{ menuActive(['admin.plans*', 'admin.category.*', 'admin.subcategory.*', 'admin.attributes*', 'admin.brand.*'], 3) }}">
        <i class="la la-product-hunt menu-icon"></i>
        <span class="menu-title">@lang('Planes')</span>
    </a>
    <div
        class="sidebar-submenu {{menuActive(['admin.plans*'], 2)}} ">
        <ul>

            <li class="sidebar-menu-item {{ menuActive('admin.plans.*') }}">
                <a class="nav-link" href="{{ route('admin.plans.index') }}">
                    <i class="las la-align-left menu-icon"></i>
                    <span class="menu-title">@lang('Planes Disponibles')</span>
                </a>
            </li>

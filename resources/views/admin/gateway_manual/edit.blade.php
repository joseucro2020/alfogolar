...
@section('panel')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.deposit.manual.update', $method->code) }}" method="POST"
                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="background-image: url('{{getImage(imagePath()['gateway']['path'].'/'. $method->image,'800x800')}}')"></div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <div class="input-group">
                                                <label class="w-100 font-weight-bold">Nombre del método <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control " placeholder="@lang('Method Name')" name="name" id="name" value="{{ $method->name }}"/>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-6">
                                            <div>
                                                <label class="w-100 font-weight-bold">@lang('Currency') <span class="text-danger">*</span></label>
                                                <input type="text" name="currency" class="form-control" value="{{ @$method->single_currency->currency }}"/>
                                            </div>
                                        </div>
                                        <div class="col-xl-5 col-md-12">
                                            ...
                                            <div class="input-group has_append">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">1 {{ trans($general->cur_text) }}=
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_limit" placeholder="0" value="{{ getAmount(@$method->single_currency->min_amount) }}" required/>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="max_limit" value="{{ getAmount(@$method->single_currency->max_amount) }}" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="fixed_charge" value="{{ getAmount(@$method->single_currency->fixed_charge) }}" required/>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="percent_charge" value="{{ getAmount(@$method->single_currency->percent_charge) }}" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--dark mt-3">
                                            ...
                                            <h5 class="card-header bg--dark">@lang('Payment Instruction')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="8" class="form-control nicEdit" name="instruction">{{ @$method->description  }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--dark mt-3">
                                            <h5 class="card-header bg--dark  text-white">@lang('Customer data')
                                                            ...
                                                            <div class="col-md-12 user-data">
                                                                <div class="form-group">
                                                                    <div class="input-group mb-md-0 mb-4">
                                                                        ...
                                                                        <div class="col-md-3 mt-md-0 mt-2">
                                                                            <select name="validation[]" class="custom-select">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.deposit.manual.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
...
@push('script')
    <script>
        ...
        'use strict';
        (function($){
            //no permitir carcateres especiales en el nombre

            ...
            <div class="card-body">
                <div class="row justify-content-end mb-2">
                        ...
                        <form action="
                            ...
                            " method="GET">
                                <div class="input-group has_append">
                                    <input type="text" name="search" class="form-control" placeholder="ID de la órden" value="{{ $key ?? '' }}">
                    ...
                    <div class="col-lg-3">
                        ...
                        >
                            <div class="input-group has_append ">
                                <input name="date" type="text" data-range="true" data-multiple-dates-separator=" to " data-language="en" class="datepicker-here form-control" data-position='bottom right' placeholder="Buscar de fecha a fecha" autocomplete="off" value="" data-date-format="dd-mm-yyyy">
                                <div class="input-group-append">
                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">ID de la órden</th>

    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Agregar Tipo de Atributo</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.attributes.store', 0) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Nombre para el administrador" value="" name="name" required/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Nombre para el usuario" value="" name="name_for_user" required/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-3">
...
<div id="editModal" class="modal fade">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Editar Tipo de Atributo</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

                            ...
                            @forelse($offers as $offer)
                                <tr>
                                    ...
                                    <td data-label="@lang('Discount Type')">
                                        ...
                                        <span class="text--small badge font-weight-normal badge--primary"> Fijo</span>
                                        @else
                                        <span class="text--small badge font-weight-normal badge--dark"> Porcentaje</span>
                                        @endif
    ...
    <script>
        ...
        (function($){
            $('.delete-btn').on('click', function ()
            {
                ...
                modal.find('.modal-title').text('{{ trans("Borrar Oferta") }}');
                modal.find('.modal-body').text('{{ trans("¿Está seguro de querer Eliminar esta Oferta?") }}');

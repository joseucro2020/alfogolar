            ...
            <div class="card">
                <div class="card-body p-0">
                        ...
                        <div class="table-responsive--md table-responsive">
                            <table class="table table--light">
                                <tr>
                                    <td colspan="100%" class="text-center"><h3 class="text--danger">Aún no agrega ninguna variante para este producto.</h3>
                                        <a class="btn btn--dark mt-3" href="{{ route('admin.products.attribute-add', [$product->id]) }}">Añadir Variante</a>
                                    </td>
                                </tr>
                    ...
                    <form action="{{route('admin.products.stock.add', $product->id)}}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group sku">
                                ...
                                <span class="text--small text--info"> <i class="fas fa-info-circle">Si desea actualizar solo el SKU, mantenga el campo Cantidad 0</i></span>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control integer-validation" name="quantity" placeholder="Cantidad">
                            </div>
                        </div>

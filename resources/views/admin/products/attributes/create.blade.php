            ...
            if(item.product_attribute.type == 1){
                content = `<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="value" required />
                            </div>

                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <input type="text" class="form-control mr-xl-2 numeric-validation" name="price" value="0" placeholder="" required />
                            </div>
                        `;
                ...
                content = `
                            ...
                            <div class="form-group">
                                <label>@lang('Price')</label>
                                <input type="text" class="form-control numeric-validation" name="price" value ="0" placeholder="" required />
                            </div>
                        `;
                modal.find('.modal-body').html(content);
                modal.find('input[name=name]').val(item.name);
        ...
        return `
                    <div class="row single-attr">
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label>@lang('Name')</label>
                                <input type="text" placeholder="" class="form-control" name="text[${itr}][name]" required />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label>@lang('Value')</label>
                                <input type="text" placeholder="" class="form-control" name="text[${itr}][value]" required />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                                <input type="text" class="form-control mr-xl-2 numeric-validation" name="text[${itr}][price]" value ="0" placeholder="" required />
    ...
    function colorContent(){
        return `
                <div class="row single-attr">
                    <div class="col-xl-4">
                        <div class="form-group"><label>@lang('Name')</label>
                            <input type="text" class="form-control" name="color[${itr}][name]" placeholder="" required />
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <label>@lang('Color')</label>
                    ...
                    <div class="col-xl-4">
                        <label>@lang('Price')</label>
                        <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                            <input type="text" class="form-control mr-xl-2 numeric-validation" name="color[${itr}][price]" value ="0" placeholder="" required />
                            <button type="button" class="btn btn-outline--danger removeBtn abs-button"><i class="la la-minus"></i></button>
                        </div>
                    </div>
                </div>
        ...
        return `
            <div class="row single-attr">
                <div class="col-xl-4">
                    <div class="form-group">
                        <label>@lang('Name')</label>
                        <input type="text" class="form-control" name="img[${itr}][name]" placeholder="" required />
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="form-group">
                ...
                <div class="col-xl-4">
                    <label>@lang('Price')</label>
                    <div class="form-group abs-form-group d-flex justify-content-between flex-wrap">
                        <input type="text" class="form-control mr-xl-2 numeric-validation" name="img[${itr}][price]" value ="0" placeholder="" required />
                        <button type="button" class="btn btn-outline--danger removeBtn abs-button"><i class="la la-minus"></i></button>
                    </div>
                </div>
            </div>

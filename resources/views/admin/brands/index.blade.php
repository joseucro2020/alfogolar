                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('Name')</th>
                                <th>@lang('Products')</th>
                                <th class="text-center">Marca Superior</th>
                                <th>@lang('Action')</th>
                            </tr>
                        </thead>
                        <tbody class="list">
                            @forelse($brands as $brand)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        <button type="button" data-toggle="tooltip" data-placement="top" title="{{ $brand->trashed()?'Restaurar':'Eliminar' }}"
                                            class="icon-btn btn--{{ $brand->trashed()?'success':'danger' }} delete-btn ml-1"
                                            data-type="{{ $brand->trashed()?'Restaurar':'Eliminar' }}"
                                            data-id='{{ $brand->id }}'>
                    ...
                    <div class="row">
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <small class="form-text text-muted mb-3"> Archivos Soportados
                                                ...
                                                La imagen cambiará de tamaño a {{imagePath()['brand']['size']}} px</b>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre de la Marca" value="{{ old('name') }}" name="name" required/>
                            ...
                            <div class="form-group">
                                <label>Título</label>
                                <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title') }}" placeholder="Título">
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nombre de la Marca</label>
                                <input type="text" class="form-control" placeholder="Nombe de la Marca" name="name" />
                                <small class="form-text text-muted"><i class="las la-info-circle"></i>Debe Ser Única</small>
                            </div>
...
@push('breadcrumb-plugins')
    ...
    @if(request()->routeIs('admin.brand.all'))
        <a href="{{ route('admin.brand.trashed') }}" class="btn btn-sm btn--danger box--shadow1 text--small"><i class="las la-trash-alt"></i>Borrados</a>
    @endif
@endpush
    ...
    <script>
        ...
        (function($){
            ...
            $('.delete-btn').on('click', function ()
            {
                ...
                if(type == 'delete'){
                    modal.find('.modal-title').text('{{ trans("Borrar Marca") }}');
                    modal.find('.modal-body').text('{{ trans("¿Estás seguro de eliminar esta marca ?") }}');
                }else{
                    modal.find('.modal-title').text('{{ trans("Restaurar Marca") }}');
                    modal.find('.btn--danger').removeClass('btn--danger').addClass('btn--success');
                    modal.find('.modal-body').text('{{ trans("¿Estás seguro de restaurar esta marca ?") }}');
                }

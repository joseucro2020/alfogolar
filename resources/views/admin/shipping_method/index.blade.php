                        ...
                        <tbody class="list">
                            @forelse($shipping_methods as $s_method)
                                <tr>
                                    ...
                                    @if($s_method->is_plan==0)
                                        <td data-label="Tipo">{{ $s_method->shipping_type==1?'Delivery':'Retiro en tienda' }}</td>
                                    @else 
                                        <td data-label="Tipo">Plan</td>
                                    @endif
        ...
        <form action="" method="POST" id="deletePostForm">
            @csrf
                ...
                <div class="modal-body">
                    ¿Está seguro de que Desea Eliminar Este Método?
                </div>

            ...
            <form action="{{ route('admin.shipping-methods.store', isset($shipping_method)?$shipping_method->id:0) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" step="0.01" class="form-control numeric-validation" placeholder="@lang('Enter Amount of Charge')" value="{{@$shipping_method->charge}}" name="charge"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <select id="shipping_type" name="shipping_type" class="form-control col-md-10">
                                    <option selected disabled>Seleccione un tipo</option>
                                    <option value="1" {{ (@$shipping_method->shipping_type==1?'selected':'')}}>Delivery</option>
                                    <option value="2" {{ (@$shipping_method->shipping_type==2?'selected':'')}}>Retiro en tienda</option>
                                </select>
                            </div>

            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('admin.password.change') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" class="form-control b-radius--capsule" id="password_confirmation"
                               placeholder="@lang('Retype New password')">
                        <i class="las la-lock input-icon"></i>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="submit-btn mt-25 b-radius--capsule">Recuperar Contraseña <i

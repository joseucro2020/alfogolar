   ...
   // alert('load')
    ...
    e(document).ready(function () {
      ...
      e(window).on("scroll", function () {
        e(this).scrollTop() < 0
          ? (a.removeClass("active"), i.removeClass("active"))
          : (a.addClass("active"), i.addClass("active"));
        e(this).scrollTop() < 0
          ? (a.removeClass("active"), w.removeClass("active"))
          : (a.addClass("active"), w.addClass("active"));
      }),
        ...
        /** Cambio 22/02/2022 Carrusel de Categorias */
        e(".xxvvxx").owlCarousel({
           loop: !0,
          margin: 0,
          mouseDrag: !1,
          touchDrag: !0,
        ...
        e("#menu-argo-button").on("click", function (i) {
          i.preventDefault(),
            e("#menu-argo-sidebar-area").addClass("active"),
            e(".body-overlay").addClass("active");
        }),
        ...
        e(".body-overlay").on("click", function () {
          e(".cart-sidebar-area").removeClass("active"),
            e(".menu-argo-sidebar-area").removeClass("active"),
            e(".body-overlay").removeClass("active"),

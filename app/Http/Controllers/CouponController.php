...
class CouponController extends Controller
{
    ...
    public function getCoupon(Request $request)
    {
        ...
        ->groupBy('coupons.id')
        ->where('coupons.coupon_code', 'like', "%$code%")
        ->first();
        ...
        if (!is_null($coupons)) {
            ...
            return response()->json(['error' => 'El cupón no está disponible']);
        }
    ...
    public function applyCoupon(Request $request)
    {
        ...
        if($coupon){
            ...
            if($request->subtotal < $coupon->minimum_spend){
                return response()->json(['error' => "Lo siento, tienes que pedir una cantidad mínima de $coupon->minimum_spend $general->cur_text"]);
            }
            ...
            if(session()->has('coupon') && session('coupon')['code'] == $request->code){
                return response()->json(['error' => 'El cupón ya ha sido aplicado']);
            }
            ...
            return response()->json(['error' => 'El cupón ya no existe']);
        }
    }
    ...
    public function removeCoupon()
    {
        ...
        return response()->json(['success'=>'El cupón ha sido removido exitosamente!']);
    }

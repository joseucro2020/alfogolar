...
class CouponController extends Controller
{
    ...
    {
        $page_title     = "Todos los Cupones";
        $empty_message  = "Sin Cupones";
    ...
    public function save(Request $request, $id)
    {
        ...
        if($id ==0){
            ...
            $notify[] = ['success', 'Cupón Editado Exitosamente'];
        }
    ...
    public function changeStatus (Request $request)
    {
        ...
        if ($coupon) {
            if ($coupon->status == 1) {
                $coupon->status = 0;
                $msg = 'Cupón Desactivado Exitosamente';
            } else {
                $coupon->status = 1;
                $msg = 'Cupón Activado Exitosamente';
            }
            $coupon->save();

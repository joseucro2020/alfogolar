...
class ManualGatewayController extends Controller
{
    ...
    {
        $page_title = 'Pasarelas de Pago Manuales';
        $gateways = Gateway::manual()->latest()->get();
        $empty_message = 'No hay Métodos de Depósito Disponibles.';
        return view('admin.gateway_manual.list', compact('page_title', 'gateways','empty_message'));
    }

    public function create()
    {
        $page_title = 'Nuevo Método de Pago Manual';
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            try {
                ...
                $notify[] = ['error', 'La imagen no pudo ser cargada.'];
        ...
        $notify[] = ['success', $method->name . ' Se ha agregado la puerta de enlace manual.'];
        return back()->withNotify($notify);
    }
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', $method->name . ' La puerta de enlace manual se ha actualizado.'];
    ...
    public function activate(Request $request)
    {
        ...
        $notify[] = ['success', $method->name . ' Ha sido activado.'];
        return back()->withNotify($notify);
    }
    ...
    public function deactivate(Request $request)
    {
        ...
        $notify[] = ['success', $method->name . ' Ha sido desactivado.'];
        return back()->withNotify($notify);
    }
}
